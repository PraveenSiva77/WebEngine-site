export default function Footer() {
  ...
  return (
    <footer className="px-8 lg:px-16 py-16 lg:py-20 bg-gradient-to-br from-black via-gray-900 to-black border-t border-gray-700/50">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-2xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">WebEngine</span>
                <span className="text-sm text-gray-400">Powering Your Digital Growth Engine</span>
              </div>
            </div>
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              Your digital transformation never stops.
            </p>
          ...
          <div className="lg:col-span-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-white font-semibold text-lg mb-4">Development</h3>
        ...
        <div className="mt-16 pt-8 border-t border-gray-700/50 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-gray-500 text-sm">
            © 2025 WebEngine. All rights reserved.
          </div>
